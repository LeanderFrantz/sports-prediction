...
def get_positive_ev_bets(
    ...
    bets = find_positive_ev_bets(odds_data, kelly_fraction=kelly_fraction, ev_threshold=ev_threshold)
...
def get_all_positive_ev_bets(
    ...
    for sport in sports:
        try:
            bets = get_positive_ev_bets(sport, kelly_fraction, ev_threshold)
